...
author_blueprint.add_url_rule('/getAll/page/<int:page_number>', methods=['GET'], view_func=controller.getAllAuthors)
...
author_blueprint.add_url_rule('/delete/', methods=['DELETE'], view_func=controller.delete_author)
